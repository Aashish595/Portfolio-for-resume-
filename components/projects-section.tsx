...
const projects = [
  ...
  },
  {
    ...
    description:
      "Developed a MERN food ordering app with real-time order tracking and an admin dashboard.",
    image: "/placeholder.svg?height=200&width=400",
    technologies: ["React", "Node.js", "Express", "MongoDB", "Stripe", "React Router DOM"],
    liveLink: "https://food-delivery-frontend-tsqv.onrender.com/",
    githubLink: "https://github.com/Aashish595/Food-delivery-App.git",
  },
  {
    id: 3,
    title: "DeepSeek Clone - AI Coding Assistant",
    description:
      "Created an AI-powered coding assistant using Next.js, Clerk, and Google Generative AI.",
    image: "/deepseek_clone.png?height=200&width=400",
    technologies: ["Next.js", "React", "MongoDB", "Express", "Clerk", "Svix", "PrismJS", "Google GenAI"],
  ...
  },
  {
    ...
    description:
      "Built a real-time MERN-based platform for 1-on-1/group video calls, chat, and screen sharing.",
    image: "/placeholder.svg?height=200&width=400",
    technologies: ["Next.js", "TypeScript", "Zustand", "TanStack Query", "Tailwind CSS", "DaisyUI", "Stream SDK", "JWT"],
    liveLink: "https://example.com",
  ...
  },
  {
    id: 6,
    title: "Food Delivery App",
    description: "Developed a MERN food ordering app with real-time order tracking and an admin dashboard.",
    image: "/placeholder.svg?height=200&width=400",
